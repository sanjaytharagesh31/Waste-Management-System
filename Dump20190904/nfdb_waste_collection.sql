...
CREATE TABLE `waste_collection` (
  ...
  PRIMARY KEY (`vehicle_id`,`area_id`,`c_date`),
  KEY `area_id` (`area_id`),
  CONSTRAINT `waste_collection_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `area` (`area_id`)
...
-- Dump completed on 2019-09-04 21:47:16
